...
struct Edge {
    ...
    Edge(int from = -1, int to = -1, double distance = 0.0, 
        EdgeType type = EdgeType::ROAD, int riskLevel = 0, 
        double congestion = 0.0) 
        : from(from), to(to), distance(distance), type(type)
        , riskLevel(riskLevel), congestion(congestion){}
